...
```{r gse253260-survival, fig.width=7, fig.height=3}
if (file.exists(info_path_253260)) {
  ...
  if (!"sample_id" %in% names(info_253260)) {
    stop("GSE253260 info RDS must contain a 'sample_id' column.")
  }
  ...
  if (length(keep_253260) > 0) {
    ...
    if (!all(c("survival_time", "survival_event") %in% names(dat_253260))) {
      stop("GSE253260 info RDS must contain 'survival_time' and 'survival_event' columns.")
    }
