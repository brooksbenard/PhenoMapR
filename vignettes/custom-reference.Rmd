...
```{r km-custom, fig.width=4, fig.height=3.5, fig.align='center'}
...
```{r km-by-stage, fig.width=5.5, fig.height=3.5, fig.align='center'}
suppressPackageStartupMessages(library(survival))
...
```{r custom-score-hist, fig.width=5, fig.height=3.5, fig.align='center'}
suppressPackageStartupMessages(library(ggplot2))
suppressPackageStartupMessages(library(dplyr))
...
```{r stage-specific-custom, fig.width=13, fig.height=3.5}
if (!requireNamespace("survminer", quietly = TRUE)) {
