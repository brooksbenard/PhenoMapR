...
if (!is.null(scoc_nhood) && !is.null(scoc_nhood$zscore)) {
  ...
  if (length(labs_ord) < 2L) {
    ...
    if (requireNamespace("ComplexHeatmap", quietly = TRUE) && requireNamespace("circlize", quietly = TRUE)) {
      ...
      col_fun <- circlize::colorRamp2(c(-mabs, 0, mabs), c("#2166AC", "#f7f7f7", "#B2182B"))
      ...
      ht <- ComplexHeatmap::Heatmap(
        ...
        column_title = paste0(
          "Neighborhood Enrichment of Prognostic Cell Types\n",
          "Stars: two-sided p from |Z| (pnorm); *** p<0.001, ** p<0.01, * p<0.05"
        ),
