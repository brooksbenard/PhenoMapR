...
## Cell type represntation in the most pehnotypically associated populations

```{r}
# plot of cell type count in the top and bottom 5th percent of cells in the dataset.

# Somethign like
ggplot(BroadClassificationFish, aes(x = Net)) +
