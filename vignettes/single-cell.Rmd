...
We use the **full** CRA001160 cohort (TISCH2 log-normalized expression H5 + cell metadata). Files are downloaded from [Google Drive](https://drive.google.com/drive/folders/1unzVigogMy6XT6KwiFJ2AnKSLsMAzl2X) on first run (or reused if already present in the working directory). The small Shiny demo subset is separate and is **not** used here.
