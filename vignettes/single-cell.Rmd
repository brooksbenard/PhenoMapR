...
# Prefer local files (repo root or vignettes/), then optional CI URL secrets,
# then public Google Drive IDs.
...
.download_vignette_file <- function(filename, drive_id, env_var) {
...
.h5_path <- .download_vignette_file(
  .h5_name,
  "1PolTXggREz8XmhutCLTQJGCfKxFAzqMl",
  "PHENOMAPR_CRA001160_H5_URL"
)
.meta_path <- .download_vignette_file(
  .meta_name,
