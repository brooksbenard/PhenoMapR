...
```
    ...
    ## [Marker analysis GSE111672] Runtime: 1.07 s | Memory: -
...
```
    ...
    ## [Heatmap GSE111672] Runtime: 2.17 s | Memory: -
...
```
    ...
    ## [Proportion plot GSE111672] Runtime: 3.17 s | Memory: -
...
```
    ...
    ## [Score CRA001160] Runtime: 0.72 s | Memory: 349.2 Mb
...
```
    ...
    ## [Marker analysis CRA001160] Runtime: 2.40 s | Memory: -
...
![](gse111672-single-cell_files/figure-html/heatmap-markers-cra001160-1.png)
    ...
    ## [Heatmap CRA001160] Runtime: 6.87 s | Memory: -
